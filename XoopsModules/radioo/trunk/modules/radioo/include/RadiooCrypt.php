 ...
 * @copyright 		phpAES http://www.phpaes.com/
 * @license 		The free version is for non-commercial use (http://www.phpaes.com/)
 * @package 		xalky
 * @since 			1.02
 * @author 			cody@wshost.net
 * @author 			Philips Data <phillipsdata@gmail.com>
 * @subpackage		Cryptology
 * @description		If you want to distribute phpAES with your application, email phillipsdata@gmail.com for pricing.
 * 
 */
...
if (!class_exists("RadiooCrypt")) {
	 ...
	 *
	 * $crypt = new RadiooCrypt($z);
	 *
	 * $data = file_get_contents("./example.txt");
	 *
	 * $start = microtime(true);
	 * //echo "\n\nCipher-Text:\n" . $crypt->encrypt($data) . "\n";
	 * echo "\n\nPlain-Text:\n" . $crypt->decrypt($crypt->encrypt($data)) . "\n";
	 * $end = microtime(true);
	 *
